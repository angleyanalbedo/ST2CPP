...
import static antlr4.PLCSTPARSERParser.RULE_fb_instance_name;
@StrategyForVisit(ruleIndex = RULE_fb_instance_name)
public class VisitFb_instance_name implements Strategy {
    @Override
