...
public class GenerateBasicTypes {
    public void generate(){
        addBasicSymbol(IDGenerator.BOOL, "BOOL", PLCModifierEnum.Sort.BOOL, "false", "BOOL",
                new int[]{},
                new int[]{},
                new int[]{IDGenerator.BOOL},
                new int[]{IDGenerator.BOOL});

        addBasicSymbol(IDGenerator.SINTID, "SINT", PLCModifierEnum.Sort.INT, "0", "SINT",
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL});
        addBasicSymbol(IDGenerator.INTID, "INT", PLCModifierEnum.Sort.INT, "0", "INT",
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL});

        addBasicSymbol(IDGenerator.DINTID, "DINT", PLCModifierEnum.Sort.INT, "0", "DINT",
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL});

        addBasicSymbol(IDGenerator.LINTID, "LINT", PLCModifierEnum.Sort.INT, "0", "LINT",
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL});

        addBasicSymbol(IDGenerator.REAL, "REAL", PLCModifierEnum.Sort.REAL, "0", "REAL",
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL},
                new int[]{IDGenerator.SINTID, IDGenerator.INTID, IDGenerator.DINTID, IDGenerator.LINTID, IDGenerator.REAL});

        addBasicSymbol(IDGenerator.SSTRING, "STRING", PLCModifierEnum.Sort.STRING, "\"\"", "STRING",
                new int[]{},
                new int[]{},
