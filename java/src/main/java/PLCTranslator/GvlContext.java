...
public class GvlContext {
    ...
    /**
     * 生成 debug_names.gen.cpp — REPL 变量名表（仅用于 ReplEngine，不进入固件）。
     * 每行一个 id + name 对，与 debug_table.cpp 的 id 一一对应。
     */
    public String dumpDebugNameTable() {
        StringBuilder sb = new StringBuilder();
        sb.append("// Auto-generated by ST2C compiler — REPL debug name table\n");
        sb.append("// NOT linked into firmware\n");
        sb.append("#include \"debug/repl_engine.h\"\n\n");
        sb.append("namespace rt_plc {\n\n");
        sb.append("extern const NameEntry st2c_debug_names[] = {\n");
        ...
        for (String varName : offsetMap.keySet()) {
            ...
            sb.append("    {").append(id).append(", \"")
              .append(escapeJson(getMangledName(varName))).append("\"},\n");
            id++;
        }
        ...
        for (String varName : ioVarMap.keySet()) {
            sb.append("    {").append(id).append(", \"")
              .append(escapeJson(varName)).append("\"},\n");
            id++;
        }

        sb.append("};\n\n");
        sb.append("extern const uint32_t st2c_debug_name_count = ").append(id - 1).append(";\n");
        sb.append("\n} // namespace rt_plc\n");
        return sb.toString();
    }
}
