...
public class PLCSTPARSERLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__140", "T__141", "T__142", "Unsigned_int", "D_byte_char", "Char_Type_name", 
			"Direct_variable", "Direct_represented", "Sign_Int_Type_Name", "Sign_Int_Type", 
			"Unsign_Int_Type_Name", "Unsign_Int_Type", "Real_Type_Name", "Real_Type", 
			"Time_Type_Name", "Time_Type", "Access_Spec", "Access", "Tod_Type_Name", 
			"Tod_Type_", "Multibits_Type_Name", "Multibits_Type", "Std_Func_Name", 
