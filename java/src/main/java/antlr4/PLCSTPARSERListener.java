...
public interface PLCSTPARSERListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PLCSTPARSERParser#assert_stmt}.
	 * @param ctx the parse tree
	 */
	void enterAssert_stmt(PLCSTPARSERParser.Assert_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link PLCSTPARSERParser#assert_stmt}.
	 * @param ctx the parse tree
	 */
	void exitAssert_stmt(PLCSTPARSERParser.Assert_stmtContext ctx);
	/**
