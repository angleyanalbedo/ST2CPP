...
void PROGRAM_test_assert_P_cyclic(GVL& gvl, ProcessImage& io, TIME dt) {
	auto& gv = rt_plc::gvl_layout(gvl);
		printf("=== ASSERT Test ===");
		printf("\n");
		{ bool _st_assert = (gv.test_assert$P$A == 42);
		  if(_st_assert)
		    printf("  [PASS] assert (line 10)\n");
		  else
		    printf("  [FAIL] assert (line 10): A=42\n"); }
		{ bool _st_assert = (gv.test_assert$P$A != 0);
		  if(_st_assert)
		    printf("  [PASS] assert (line 11)\n");
		  else
		    printf("  [FAIL] assert (line 11): A<>0\n"); }
		{ bool _st_assert = (gv.test_assert$P$B == 0);
		  if(_st_assert)
		    printf("  [PASS] assert (line 12)\n");
		  else
		    printf("  [FAIL] assert (line 12): B=0\n"); }
		{ bool _st_assert = (gv.test_assert$P$A + gv.test_assert$P$B == gv.test_assert$P$A);
		  if(_st_assert)
		...
		{ bool _st_assert = (gv.test_assert$P$A > gv.test_assert$P$B);
		  if(_st_assert)
		...
		gv.test_assert$P$C = gv.test_assert$P$A + 10;
		{ bool _st_assert = (gv.test_assert$P$C == 52);
		  if(_st_assert)
