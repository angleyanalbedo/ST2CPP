...
void registerPOU_test_array_simple(POURegistry& reg) {
    POUCallbacks cbs;
    cbs.init = PROGRAM_test_array_simple_P_init;
    cbs.cyclic = PROGRAM_test_array_simple_P_cyclic;
    cbs.pre = PROGRAM_test_array_simple_P_pre;
    cbs.post = PROGRAM_test_array_simple_P_post;
    reg.add("P", cbs);
}
