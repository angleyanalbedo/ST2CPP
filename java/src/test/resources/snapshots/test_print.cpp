...
void PROGRAM_test_print_MAIN_init(GVL& gvl, ProcessImage& io) {
	auto& gv = rt_plc::gvl_layout(gvl);
		gv.test_print$MAIN$A = 42;
		gv.test_print$MAIN$B = 10;
}
...
void PROGRAM_test_print_MAIN_cyclic(GVL& gvl, ProcessImage& io, TIME dt) {
	auto& gv = rt_plc::gvl_layout(gvl);
		gv.test_print$MAIN$C = gv.test_print$MAIN$A + gv.test_print$MAIN$B;
		printf("C = ");
		printf("%d", (int)(gv.test_print$MAIN$C));
		printf("\n");
		printf("A = ");
		printf("%d", (int)(gv.test_print$MAIN$A));
		printf("\n");
		printf("%d", (int)(gv.test_print$MAIN$B));
		printf("\n");
		printf("%d", (int)(gv.test_print$MAIN$C));
		printf("\n");
		if(gv.test_print$MAIN$C == 52){
		printf("%d", (int)(gv.test_print$MAIN$A));
		printf("\n");
		}
}
