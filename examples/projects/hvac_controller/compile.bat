...
REM HVAC Controller — 集成测试编译运行脚本 (Windows)
...
REM Step 3-4: Build runtime with POU (registry auto-generated by Makefile)
...
REM Step 4: Run integration test
echo [4/5] Running HVAC integration test...
